...
async function main() {
  ...
  results.push(await measure('typeorm-query-find-many', findMany))
  results.push(
    await measure(
      'typeorm-query-find-many-with-relations',
      findManyWithRelations
    )
  )
  results.push(
    await measure(
      'typeorm-query-find-many-with-relations-filter-and-pagination',
      findManyWithRelationsFilterAndPagination
    )
  )
  results.push(
    await measure(
      'typeorm-query-find-many-with-nested-where',
      findManyWithNestedWhere
    )
  )
  results.push(
    await measure(
      'typeorm-query-find-many-with-nested-where-select-and-pagination',
